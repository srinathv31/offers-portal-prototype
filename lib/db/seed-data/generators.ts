...
export const SPENDING_GROUP_CONFIGS: SpendingGroupConfig[] = [
  {
    ...
    merchants: [
      { name: "Delta Airlines", category: "Travel", amountRange: [25000, 80000] },
      { name: "United Airlines", category: "Travel", amountRange: [30000, 90000] },
      { name: "American Airlines", category: "Travel", amountRange: [28000, 85000] },
      { name: "Southwest Airlines", category: "Travel", amountRange: [15000, 45000] },
      { name: "JetBlue Airways", category: "Travel", amountRange: [12000, 40000] },
      { name: "Marriott Hotels", category: "Travel", amountRange: [20000, 60000] },
      { name: "Hilton", category: "Travel", amountRange: [18000, 55000] },
      { name: "Hyatt Hotels", category: "Travel", amountRange: [22000, 65000] },
      { name: "Four Seasons", category: "Travel", amountRange: [35000, 120000] },
  ...
  },
  {
    ...
    merchants: [
      { name: "Whole Foods", category: "Groceries", amountRange: [8000, 25000] },
      { name: "Trader Joe's", category: "Groceries", amountRange: [5000, 18000] },
      ...
      { name: "Walmart Grocery", category: "Groceries", amountRange: [7000, 22000] },
      { name: "Target Grocery", category: "Groceries", amountRange: [5000, 15000] },
      { name: "Aldi", category: "Groceries", amountRange: [4000, 12000] },
      { name: "Shell Gas", category: "Gas Stations", amountRange: [4000, 8000] },
      { name: "Chevron", category: "Gas Stations", amountRange: [4500, 8500] },
      { name: "ExxonMobil", category: "Gas Stations", amountRange: [4000, 7500] },
      { name: "BP", category: "Gas Stations", amountRange: [3500, 7000] },
      { name: "Costco Gas", category: "Gas Stations", amountRange: [5000, 9000] },
    ],
  ...
  },
  {
    ...
    merchants: [
      { name: "Amazon", category: "Online Shopping", amountRange: [3000, 35000] },
      { name: "Amazon Prime", category: "Online Shopping", amountRange: [1500, 5000] },
      { name: "eBay", category: "Online Shopping", amountRange: [2500, 20000] },
      { name: "Etsy", category: "Online Shopping", amountRange: [3000, 15000] },
      { name: "Wayfair", category: "Online Shopping", amountRange: [10000, 50000] },
      { name: "Best Buy Online", category: "Online Shopping", amountRange: [8000, 60000] },
      { name: "Walmart.com", category: "Online Shopping", amountRange: [4000, 25000] },
      { name: "Target.com", category: "Online Shopping", amountRange: [3500, 20000] },
      { name: "Zappos", category: "Online Shopping", amountRange: [5000, 18000] },
      { name: "Chewy", category: "Online Shopping", amountRange: [4000, 15000] },
    ],
    targetTiers: ["DIAMOND", "PLATINUM", "GOLD", "STANDARD"],
  ...
  },
  {
    ...
    merchants: [
      ...
      { name: "Cheesecake Factory", category: "Dining", amountRange: [4000, 12000] },
      { name: "Olive Garden", category: "Dining", amountRange: [3500, 10000] },
      { name: "Red Lobster", category: "Dining", amountRange: [4000, 11000] },
      { name: "Outback Steakhouse", category: "Dining", amountRange: [4500, 12000] },
      { name: "Ruth's Chris", category: "Dining", amountRange: [15000, 40000] },
      { name: "DoorDash", category: "Food Delivery", amountRange: [2500, 6000] },
      { name: "Uber Eats", category: "Food Delivery", amountRange: [2000, 5500] },
      { name: "Grubhub", category: "Food Delivery", amountRange: [2200, 5000] },
      { name: "Local Restaurant", category: "Dining", amountRange: [3000, 10000] },
    ],
    targetTiers: ["DIAMOND", "PLATINUM", "GOLD", "STANDARD"],
  ...
  },
  {
    ...
    merchants: [
      ...
      { name: "Neiman Marcus", category: "Retail", amountRange: [20000, 80000] },
      { name: "Saks Fifth Avenue", category: "Retail", amountRange: [18000, 70000] },
      { name: "Apple Store", category: "Electronics", amountRange: [50000, 200000] },
      { name: "Tesla", category: "Auto", amountRange: [100000, 500000] },
      { name: "Louis Vuitton", category: "Retail", amountRange: [30000, 150000] },
      { name: "Tiffany & Co", category: "Retail", amountRange: [25000, 100000] },
      { name: "Delta Airlines", category: "Travel", amountRange: [30000, 100000] },
      { name: "Four Seasons", category: "Travel", amountRange: [40000, 150000] },
    ],
    targetTiers: ["DIAMOND", "PLATINUM"],
...
export const GENERAL_MERCHANTS: MerchantConfig[] = [
  ...
  { name: "Home Depot", category: "Home Improvement", amountRange: [5000, 30000] },
  ...
  { name: "AMC Theatres", category: "Entertainment", amountRange: [2500, 6000] },
  // Utilities
  { name: "AT&T", category: "Utilities", amountRange: [8000, 15000] },
  { name: "Verizon", category: "Utilities", amountRange: [8500, 16000] },
  { name: "Electric Company", category: "Utilities", amountRange: [10000, 25000] },
];
...
export function generateAccount(
  ...
  const transactionsPerMonth = Math.round(annualSpend / 12 / avgTransactionAmount);
  ...
  const primaryCategories = faker.helpers.arrayElements(allCategories, numCategories);
...
export function generateTransactionsForAccount(
  ...
  enrollmentMap: Map<string, { enrollmentId: string; category: string; vendor: string | null }>
      ...
      if (key.startsWith(accountId)) {
        ...
        if (matchesCategory || matchesVendor) {
          ...
          qualificationMetadata = {
            qualification: {
              qualified: true,
              reason: `Transaction matches ${enrollment.vendor || enrollment.category} offer criteria`,
              details: {
...
export function assignAccountsToSpendingGroups(
  accounts: Array<{ id: string; tier: AccountTier; annualSpend: number; spendingProfile: SpendingProfile }>
  ...
  for (const groupConfig of SPENDING_GROUP_CONFIGS) {
    ...
    const eligibleAccounts = accounts.filter((account) => {
      ...
      if (groupConfig.minAnnualSpend && account.annualSpend < groupConfig.minAnnualSpend) {
        return false;
      }
      // Check if account has relevant spending categories
      const hasRelevantCategory = account.spendingProfile.primaryCategories.some(
...
export function getMerchantsForAccount(
  ...
  for (const [groupName, assignments] of groupAssignments) {
    ...
    if (isInGroup) {
      const groupConfig = SPENDING_GROUP_CONFIGS.find((g) => g.name === groupName);
      if (groupConfig) {
